...
# SQLALCHEMY_DATABASE_URI = "sqlite:///" + os.path.join(DATA_DIR, "james_superset.db")
SQLALCHEMY_DATABASE_URI = 'mysql+pymysql://developer:developer@localhost:3306/james_superset'
